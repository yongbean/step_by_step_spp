  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('User Status', style: appBarTextStyle),
      ),
      body: Container(
              ...
              child: Column(
                ...
                children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (userData['startAddress'] != null && (userData['startAddress'] as String).isNotEmpty)
                                  Padding(
                  ...
                  Row(
                    ...
                    children: [
                      const Text('Recent Activity', style: pageTitleStyle),
                      TextButton(
  ...
  Widget _buildActivityItem({
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () => context.push('/userStatus/activity/$activityId'),
      ),
    );
  }
}